...
const Greetings = () => {
  return (
    // <div id="get-started">
    <MainBar pageTitle="Welcome to manufacturer dashboard test">
...
const GetStarted = ({ contract, account }) => {
  ...
  console.log({show, account, pathname: pathname.split('/')[2], isLinkPage, arrURL});
    ...
    return (
      <div>
        <div style={{ textAlign: "center", marginTop: 40 }}>
          <h2 className="primary-txt">OOPs 🙊 your company is not registerd test nikki </h2>
  ...
  console.log({ isLinkPage, currentPageURL})
